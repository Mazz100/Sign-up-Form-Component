...
sign_form.addEventListener("submit", submission => {
    ...
    if (isEmailValid && firstName.value.trim() !== '' && lastName.value.trim() !== ''
        && password.value.trim() !== '') {
        SuccessMessage();
    }
...
function SuccessMessage() {
    // Reset all errors and display success text
    ...
    claimedText.classList.add('claimed-trial');
    claimedText.innerHTML = 'Thanks for claiming trial!';
}
